...
export default function Page() {
  ...
  return (
    <div className="border bg-white ">
      <h1 className="bg-yellow-500 w-full text-center font-extrabold text-3xl text-black">
        Chat App{" "}
      </h1>
      <div className="  flex justify-center items-center border-2 ">
        <div className=" border-4 border-black rounded-2xl bg-yellow-400 mt-4 flex   justify-center items-center lg:w-[500px] w-[350px] gap-10 m-2">
          <div className="flex flex-col gap-2 justify-center items-center">
            <label
              className="text-center label font-serif font-extrabold text-black"
              htmlFor=""
            >
              Enter Room Name:
            </label>
          ...
          <div className="flex flex-col justify-center items-center gap-2 ">
            ...
            />
            <button
              className=" flow glass bg-yellow-600 w-20  rounded-xl text-black "
      ...
      <div>
        <h1 className="bg-gray-300 mt-10 text-center text-black">
          crafted by Priya and Viji team
        </h1>
      </div>
    </div>
  );
